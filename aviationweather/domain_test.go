...
func TestHostWiring(t *testing.T) {
	...
	if want := "aviationweather://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("aviationweather", "about")
	if err != nil || got.String() != "aviationweather://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want aviationweather://page/about", got.String(), err)
	}
}
