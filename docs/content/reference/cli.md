...
```
aviationweather <command> [arguments] [flags]
```

Run `aviationweather <command> --help` for the full flag list on any command. This
...
per operation you declare in `aviationweather/domain.go`.
