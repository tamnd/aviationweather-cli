...
Most of these come down to network reality or how aviationweather serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

aviationweather rate-limits like any public site. aviationweather already paces
...
Where a surface is gated, aviationweather reads a cookie or token you supply
...
`aviationweather`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what aviationweather actually did
